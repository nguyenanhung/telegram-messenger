...
trait TelegramOptions
{
     ...
     * @return $this
     */
    public function setMessageThreadId($message_thread_id): self
    {
     ...
     * @return $this
     */
    public function setCaptionEntities($caption_entities): self
    {
     ...
     * @return $this
     */
    public function setLinkPreviewOptions($link_preview_options): self
    {
     ...
     * @return $this
     */
    public function setReplyParameters($reply_parameters): self
    {
     ...
     * @return array
     */
    public function bindParams(array $params = array()): array
    {
